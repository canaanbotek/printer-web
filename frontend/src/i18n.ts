...
const messages = {
  en: {
    ...
    contact: {
      ...
      fileSizeError: "The file exceeds the maximum allowed size",
      fileTypeError: "Prohibited file types: PNG, JPG, JPEG images, PDF files, ZIP files, and 3D files such as .stl, .step, .3mf, or .gcode.",
      sendOk: "Message sent",
      sendFail: "The sending failed, please try again",
      sendFailServer: "Server sending failure",
      sendButton: "Send",
  ...
  es: {
    ...
    contact: {
      ...
      fileSizeError: "El archivo supera el tamaño máximo permitido.",
      fileTypeError: "Tipo de archivo no permitido. imágenes png, jpg, jpeg, archivos PDF, ZIP y archivos 3D como .stl, .step, .3mf o .gcode.",
      sendOk: "Mensaje enviado",
      sendFail: "El envio fallo, reintente nuevamente",
      sendFailServer: "Fallo de envio en el servidor",
      sendButton: "Enviar",
